...
- Si el usuario pregunta por resumen, balance, gastos con comparación entre períodos (ej: "en comparación al año pasado", "noviembre vs octubre"), responde con intent "query_comparison" y extrae month, year, compare_year (año de comparación), compare_month (mes de comparación) y type ("income" | "expense" | "balance" si se menciona "ingresos", "gastos" o "balance").
- Si el usuario pregunta por resumen, balance, gastos altos, recurrentes SIN comparación, responde con intent "query_summary" o "query_top_expenses" según corresponda y extrae type ("income" | "expense" | "balance") si aplica. Evita poner "ingresos" o "gastos" como category; usa type en su lugar.
